...
const ROBOT_ROCK_ANIM_SRC = '.grondal04/rps/assets/gameplay/no-loop-count-clean/robot-rock.gif'
const ROBOT_PAPER_ANIM_SRC = '.grondal04/rps/assets/gameplay/no-loop-count-clean/robot-paper.gif'
const ROBOT_SCISSORS_ANIM_SRC = '.grondal04/rps/assets/gameplay/no-loop-count-clean/robot-scissors.gif'

const HUMAN_ROCK_ANIM_SRC = '.grondal04/rps/assets/gameplay/no-loop-count-clean/human-rock.gif'
const HUMAN_PAPER_ANIM_SRC = '.grondal04/rps/assets/gameplay/no-loop-count-clean/human-paper.gif'
const HUMAN_SCISSORS_ANIM_SRC = '.grondal04/rps/assets/gameplay/no-loop-count-clean/human-scissors.gif'
